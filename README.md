...
### Section Renaming
This technique merely uses a list of common PE section names and renames the section with a name from that list.  Some of these common section names are `.ndata`, `.bss`, `edata`, etc.
